...
const title = 'Dashboard of a supermarket';
const description =
...
const roles = ['Data Research', 'Data Patterns', 'Dashboard'];
    ...
    <Fragment>
      <ProjectContainer className={styles.slice}>
        ...
        <ProjectHeader
          ...
          url="https://trainings.internshala.com/uploads/tableau-ds-pgc/uploads/projects/v_1/3830324/65b20b1d9c8e4.zip"
          roles={roles}
        />
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow>
              ...
              <ProjectSectionText>
              The project successfully delivered an interactive Tableau dashboard for "The Bike Haven," enabling comprehensive analysis of sales data. Through intuitive visualizations and user-friendly features, stakeholders gained deeper insights into sales performance and customer trends. The implementation of filters allowed for customized data exploration, enhancing decision-making capabilities. The dashboard's seamless accessibility across devices ensured widespread usability. Overall, the project laid a foundation for informed strategic planning and positioned "The Bike Haven" for continued growth and success. Moving forward, continual optimization and refinement of the dashboard will further support data-driven initiatives and business objectives.
              </ProjectSectionText>
            </ProjectTextRow>
            <Image
              src={sliceIrl}
