...
const title = 'Predicting Rainfall for sydney using Machine Learning';
const description =
    ...
    <>
      <ProjectContainer>
        ...
        <ProjectHeader
          ...
          url="https://trainings.internshala.com/uploads/interview-preparation-ds-pgc/uploads/projects/v_1/3830326/65d10229055b3.zip"
          roles={roles}
        />
...
<ProjectSectionText>
The Python machine learning project aimed at predicting rainfall in Sydney proved to be a triumph. The insights garnered from the project were instrumental in enhancing predictive capabilities. As a result, it facilitated informed decision-making processes and laid the groundwork for further advancements in weather forecasting.
</ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
